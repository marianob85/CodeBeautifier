...
{
    [TypeConverter( typeof( FormatOptionForLanguageCConverter ) )]
    public class FormatOptionForLanguageC
    {
        ...
        public FormatOptionForLanguageC()
        { }
        ...
        public class FormatOptionForLanguageCConverter : ExpandableObjectConverter
        {
            ...
            {
                if( destType == typeof( string ) && value is FormatOptionForLanguageC )
                {
                    return "...";
                }
        ...
        public override bool Equals( Object other )
        {
            ...
            return Equals( (FormatOptionForLanguageC)other );
        }
